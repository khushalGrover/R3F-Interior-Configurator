...
export function Model(props) {
  const { nodes, materials } = useGLTF('/Drawing.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes['D-Self-B'].geometry} material={materials.material_18} position={[15.188, 1.956, -18.077]} />
